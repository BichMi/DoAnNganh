    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_airline', models.FloatField(blank=True, default=0.0, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Airport',
            fields=[
                ...
                ('address_airport', models.CharField(max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price_ticket_book', models.FloatField(blank=True, default=0.0, null=True)),
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirlineTicketApp.Book')),
            ],
        ),
        migrations.CreateModel(
            name='Flight',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numbers_gate', models.IntegerField(null=True)),
                ('airline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirlineTicketApp.Airline')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_seat_class', models.FloatField(blank=True, default=0.0, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='TypeTicket',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_ticket_name', models.SmallIntegerField(choices=[(0, 'Adults'), (1, 'Childrent'), (2, 'Baby')])),
                ('price_type_ticket', models.FloatField(blank=True, default=0.0, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='TypeUser',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_user_name', models.CharField(max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('type_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirlineTicketApp.TypeUser')),
        ...
        migrations.AddField(
            model_name='bookinfo',
            name='type_seat',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirlineTicketApp.TypeSeat'),
        ),
        migrations.AddField(
            model_name='bookinfo',
            name='type_ticket',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirlineTicketApp.TypeTicket'),
        ),
        migrations.AddField(
            model_name='book',
            name='flight',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AirlineTicketApp.Flight'),
        ),
        migrations.AddField(
            model_name='book',
            name='user',
            field=models.ForeignKey(help_text='Khach Hang', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
    ]
